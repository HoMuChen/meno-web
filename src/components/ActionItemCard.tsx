...
interface ActionItemCardProps {
  item: ActionItem
  onStatusChange: (itemId: string, projectId: string, meetingId: string, newStatus: 'pending' | 'in_progress' | 'completed') => void
      ...
      {isEditing ? (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start justify-between gap-4">
            <p className="flex-1 font-medium text-sm">{item.task}</p>
