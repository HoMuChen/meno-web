import type { SocialMedia } from '@/types/person'
...
export function SocialMediaIcons({ socialMedia, size = 16, className = '' }: SocialMediaIconsProps) {
    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {socialMedia.github && (
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#181717] dark:text-[#FFFFFF] hover:opacity-80 transition-opacity"
          title="GitHub"
        >
